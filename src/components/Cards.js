    ...
    return (
        <div>
            ...
            <div className='cards'>
                ...
                <h1 className='w-full text-5xl font-bungeeInline text-center bg-gradient-to-b from-red-500 to-black bg-clip-text text-transparent md:text-9xl pt-12 pb-12' id='blackoutline'>Fight <br></br><span className='bg-clip-text text-transparent bg-gradient-to-b from-red-500 to-black' id='blackoutline'>Culture</span></h1>
