...
function Classes() {
    ...
    return (
        <div>
            <div className="flex flex-col bg-[url('/images/white-brick-wall.jpg')] pb-20">
                ...
                <div className='md:flex'>
                    <div id='fadeInLeft' className='flex-col justify-center items-center m-auto md:w-6/12'>
                            ...
                            <div className='pb-5 pt-5 flex items-center justify-center'>
                                <img className='w-8/12 shadow-[0_5px_20px_red] rounded-xl' src='images/fc_muaythai_3.jpg' alt='FCmuaythai'></img>
                            </div>
                            <p className='w-screen px-12 pb-40 text-l font-medium text-center md:w-full md:py-3 md:px-20 lg:px-20 lg:pt-10 lg:text-2xl font-bold'>
                    ...
                    <div id='fadeInRight' className='flex-col justify-center items-center m-auto md:w-6/12'>
                            <h1 className='text-6xl font-rubikDirt text-center md:text-6xl lg:text-8xl lg:py-3'> Brazilian <br></br> JiuJitsu </h1>
                            <div className='pb-5 pt-5 flex items-center justify-center'>
                                <img id='fadeInRight' className='w-8/12 shadow-[0_5px_20px_red] rounded-xl' src='images/fc_jiujitsu_3.jpg' alt='FCjiujitsu'></img>
                            </div>
                            <p className='w-screen px-12 pb-40 text-l font-medium text-center md:w-full md:py-3 md:px-20 lg:px-20 lg:pt-10 lg:text-2xl font-bold'>
                ...
                <div className='md:flex md:pt-40'>
                    <div className='flex-col justify-center items-center m-auto md:w-6/12'>
                            ...
                            <div className='pb-5 pt-5 flex items-center justify-center'>
                                <img id='fadeInRight' className='w-8/12 shadow-[0_5px_20px_red] rounded-xl' src='images/fc_wrestling.jpg' alt='FCwrestling'></img>
                            </div>
                            <p className='w-screen px-12 pb-40 text-l font-medium text-center md:w-full md:py-3 md:px-20 lg:px-20 lg:pt-10 lg:text-2xl font-bold'>
                    ...
                    <div className='flex-col justify-center items-center m-auto md:w-6/12'>
                            ...
                            <div className='pb-5 pt-5 flex items-center justify-center'>
                                <img id='fadeInRight' className='w-8/12 shadow-[0_5px_20px_red] rounded-xl' src='images/fc_boxing.jpg' alt='FCboxing'></img>
                            </div>
                            <p className='w-screen px-12 pb-40 text-l font-medium text-center md:w-full md:py-3 md:px-20 lg:px-20 lg:pt-10 lg:text-2xl font-bold'>
